...
def main():
    ...
    # uncomment this to try tuning
    # best = find_best_params(train_set, valid_set)
    # best params we found
    best = {'boosting_type': 'dart', 'metric': 'auc', 'colsample_bytree': 0.7912493015275733, 'learning_rate': 0.1825037992404684, 'min_child_samples': 95, 'num_leaves': 48, 'reg_alpha': 0.5753421176471192, 'reg_lambda': 0.6231841891673146, 'subsample_for_bin': 20000}
